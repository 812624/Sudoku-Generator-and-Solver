/*
 * DISCRIPTION        : This file has solver function defined, programmed to solve
 * 						given sudoku by backtracking 
 *
 * RECEIVED PARAMETER : Accepts an object of ifstream class
 * 	
 */
